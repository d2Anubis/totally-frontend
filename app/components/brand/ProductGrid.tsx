    ...
    <>
      ...
      {showViewAllButton && (
        <div className="flex justify-center mb-8">
          <button className="bg-white text-blue-00 border border-blue-00 px-5 py-2 rounded-lg button hover:bg-blue-00 hover:text-white transition-colors whitespace-nowrap">
            View All
          </button>
        </div>
      )}
